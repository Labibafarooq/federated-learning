...
class FedAvgStrategy(Strategy):
    def __init__(self, alpha: str = "alpha10", initial_parameters: Optional[Parameters] = None):
        ...
        # 👇 Optional: metrics aggregation function for centralized results
    ...
    def configure_fit(
        ...
        print(f"[Strategy] Configuring fit for round {server_round}")
    ...
    def aggregate_fit(
        ...
        print(f"[Strategy] Aggregating fit results for round {server_round}")
        if not results:
            return None, {}
