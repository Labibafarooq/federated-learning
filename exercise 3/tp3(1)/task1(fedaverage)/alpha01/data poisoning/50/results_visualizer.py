...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_fedavg_data_50.json"   # <--- Update this if your file is different
    fig_output = "figures_alpha01_data50%"              # <--- Folder to save plots
