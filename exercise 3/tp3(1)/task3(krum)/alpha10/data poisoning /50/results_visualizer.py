...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_krum_alpha10_data_50.json"  # <--- Update this if your file is different
    fig_output = "figures_krum_alpha10_data50%"              # <--- Folder to save plots
