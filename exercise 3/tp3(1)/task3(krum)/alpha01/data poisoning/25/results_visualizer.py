...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_krum_alpha01_data_25.json"   # <--- Update this if your file is different
    fig_output = "figures_krum_alpha01_data25%"              # <--- Folder to save plots
