...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_fedmedian_data_25_alpha10.json"   # <--- Update this if your file is different
    fig_output = "figures_median_alpha10_data25%"              # <--- Folder to save plots
