...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_fedmedian_model_50_alpha01.json"   # <--- Update this if your file is different
    fig_output = "figures_median_alpha01_model50%"              # <--- Folder to save plots
