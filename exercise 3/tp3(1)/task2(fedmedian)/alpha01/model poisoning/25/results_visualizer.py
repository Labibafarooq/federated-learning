...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_fedmedian_model_25_alpha01.json"   # <--- Update this if your file is different
    fig_output = "figures_median_alpha01_model25%"              # <--- Folder to save plots
