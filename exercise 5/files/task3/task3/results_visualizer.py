...
def main():
    ...
    json_file = "/home/hproc03/Documents/federationLearning/server_history_alpha1.json"   # <--- Update this if your file is different
    fig_output = "figures_alpha1"              # <--- Folder to save plots
